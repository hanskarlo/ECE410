...
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { Sum[2] }]; #IO_0_35 Sch=led[2]
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { C_out }]; #IO_L3N_T0_DQS_AD1N_35 Sch=led[3]
...
##RGB LED 6
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { compare_result[2] }]; #IO_L18P_T2_34 Sch=led6_r
set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports { compare_result[0] }]; #IO_L6N_T0_VREF_35 Sch=led6_g
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { compare_result[1] }]; #IO_L8P_T1_AD10P_35 Sch=led6_b
